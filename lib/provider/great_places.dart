...
import 'package:great_places_app/helpers/helpers.dart';
...
class GreatPlaces with ChangeNotifier {
  ...
  Future<void> addPlace(String pickedTitle, File? pickedImage, PlaceLocation? pickedLocation) async {
    final address = await LocationHelper.getPlacesAddress(pickedLocation!.latitude, pickedLocation!.latitude);
